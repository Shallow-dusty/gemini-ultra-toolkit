...
_Last updated: 2026-05-21 (v12.0)_
...
- **No reading of conversation content.** The extension only reads sidebar titles and your own message counts — never the body of your chats or Gemini's responses.
...
- The body of any prompt you type.
- The body of any response Gemini returns.
...
- **Export**: the Export module produces JSON / CSV / Markdown files written via the browser's download flow. Files contain only data already stored locally.
