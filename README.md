...
| **Export** | Export usage reports, the current visible chat transcript, or selected sidebar chats, including HTML/DOCX transcript files and explicit bounded transcript packets |
