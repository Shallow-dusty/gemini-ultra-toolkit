...
| **Export** | Export usage reports, the current visible chat transcript, or selected sidebar chats, including HTML transcript files and explicit bounded transcript packets |
