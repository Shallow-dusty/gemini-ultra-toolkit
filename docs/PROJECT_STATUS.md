...
- `npm test` — 259 passing tests; `lib/` remains at 100% c8 coverage.
- `npm run build` — userscript and extension builds complete (~504.5 kb
  ...
  quota reset-window framing, prompt-chain queueing, HTML/DOCX transcript export,
