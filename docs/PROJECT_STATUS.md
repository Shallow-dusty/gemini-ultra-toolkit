...
Updated: 2026-06-08 — v12.0 released; selected-chat export, local folder undo, local data portability, local context references, quota reset-window framing, and prompt-chain queueing added; live smoke still pending.
...
- `npm test` — 236 passing tests; `lib/` remains at 100% c8 coverage.
- `npm run build` — userscript and extension builds complete (~452.8 kb
  ...
  insertion, quota reset-window framing, and prompt-chain queueing).
