...
- `npm test` — 262 passing tests; `lib/` remains at 100% c8 coverage.
- `npm run build` — userscript and extension builds complete (~508.1 kb
  ...
  quota reset-window framing, prompt-chain queueing, CSV/HTML/DOCX transcript export,
  composer input counter, adapter probe export, and broader i18n hardening).
